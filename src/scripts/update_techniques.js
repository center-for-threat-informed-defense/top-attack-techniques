...
function addRelationships(techniques) {
  // const wb2 = new ExcelJS.Workbook();
  // const mitigations = [];
  // const newTechniques = [];
  // wb2.xlsx.readFile(SOURCE_FILE).then(function () {
  //   console.log("Reading from Relationship spreadsheet...");
  //   const mitigationSheet = wb2.getWorksheet("mitigations");
  //   console.log("Parsing mitigation objects");
  //   mitigationSheet.eachRow((r) => {
  //     if (r.number > 1) {
  //       const m = {};
  ...
  //     }
  //   });
  //   // console.log("mitigations ", mitigations[0]);
  //   const relationshipSheet = wb2.getWorksheet("relationships");
  //   relationshipSheet.eachRow((r) => {
  //     if (
  //       r.number > 1 &&
  //       r.getCell(1).value &&
  //       r.getCell(1).value.charAt(0) === "M"
  //     ) {
  //       // console.log("has value ", r.getCell(1).value, r.getCell(5).value);
  //       const mitigation = mitigations.find(
  //         (m) => m.mid === r.getCell(1).value
  //       );
  //       const technique = techniques.find((t) => t.tid === r.getCell(5).value);
  //       technique.mitigations.push(mitigation);
  ...
  //     }
  //   });
  //   const str = JSON.stringify(newTechniques, null, 4);
  //   fs.writeFile(TEST_DESTINATION_FILE, str, (error) => {
  //     if (error) {
  //       console.error(error);
  //       throw error;
  //     }
